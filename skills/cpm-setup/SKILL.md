---
name: "cpm-setup"
description: Sets up Cinematic Production Module module in a project. Use when the user requests to 'install cpm module', 'configure Cinematic Production Module', or 'setup Cinematic Production Module'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/cpm/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code cpm
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code cpm --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
